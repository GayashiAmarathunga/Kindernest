  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginTop: 20 }}>
        <TextInput style={styles.input} placeholderTextColor={'black'} placeholder='Username'></TextInput>
        <TextInput secureTextEntry style={styles.input} placeholderTextColor={'black'} placeholder='Password'></TextInput>
        <TouchableOpacity onPress={() => navigation.navigate('PHome')} style={styles.button}><Text style={{ fontSize: 20, padding: 10, textAlign: 'center', fontWeight: 'bold' }}>Login</Text></TouchableOpacity>
      </View>
